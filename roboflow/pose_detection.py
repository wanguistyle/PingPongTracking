...
df_annotations = pd.read_csv("data/dataset_labelise/video_simple/video_simple.mp4.csv")
...
# --- BOUCLE VIDÉO ---
cap = cv2.VideoCapture("data/dataset_labelise/video_simple/video_simple.mp4")
